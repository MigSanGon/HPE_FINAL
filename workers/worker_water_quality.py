    ...
    try:
        async for msg in consumer:
            ...
            try:
                await conn.execute(
                    """
                    INSERT INTO sensor_metrics_water_quality (ph_level, sensor_id, turbidity, event_time, conductivity, dissolved_oxygen, water_temperature)
...
if __name__ == "__main__":
    asyncio.run(consume_and_insert_water_quality())
